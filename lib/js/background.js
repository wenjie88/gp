...
//     if (sender.tab.title === "亚马逊卖家平台") {
//         // console.log(req)
//         // console.log(sender)
//         // console.log(sendres)
//         localStorage.UserAccount = req.UserAccount
//     }
// })
...
function WJGP() {
    ...
    this.rule_filter = (gplist) => {
        ...
        for (var i in gplist) {
            ...
            var jun_10 = result[18] //10日均线
            var jun_20 = result[19] //20日均线
            var jun_30 = result[20] //30日均线
            var jun_60 = result[21] //60日均线
            var jun_180 = result[22] //180日均线
            var jun_250 = result[23] //250日均线
            ...
            //2.1 第二天跌幅少于1.5%的排除
            if (Math.abs(Number(region_percent_arr[1])) < 1.5) continue
            ...
            //5.股价在所有均线下的排除 向下浮动1%
            // var f = 1 - 0.01
            // if (now_price < jun_10 * f && now_price < jun_20 * f
            //     && now_price < jun_30 * f && now_price < jun_60 * f
            //     && now_price < jun_180 * f && now_price < jun_250 * f) {
            //     continue
            // }
